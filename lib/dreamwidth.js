...
class Dreamwidth {
	...
	let sec = { security: opt.security || 'private' }
	// this is how you do it for 'friends-only'
	// github.com/dreamwidth/dw-free/blob/2da5cc8/htdocs/mobile/post.bml#L47
	if (opt.security === 'friends') {
	    sec.security = 'usemask'
	    sec.allowmask = 1
	}
	params = Object.assign(params, sec)

	return this.method_call_auth('LJ.XMLRPC.postevent', params)
    }
